...
?>
<?php if (isset($_GET['id']) || isset($_POST['btnGuardar'])) :?>
    <?php 
        
        $idUrl = $_GET['id'];
        $shortCodeUrl = "[SC_CT id='$idUrl']"; 
        
    ?>
    <div class="card border-primary mb-3" style="max-width: 28rem;">
        <div class="card-header">ShortCode</div>
            <div class="card-body text-primary">
                <h5 class="card-title"><?= $shortCodeUrl;?></h5>
            </div>
        </div>
    <?php endif; ?>
  ...
  <div class="row row-cols-1 row-cols-sm-2 row-cols-md-2" >
    <div class="col">
        ...
        <div class="modal-body">
                ...
                <tr>  
                    ...
                    <tr>
                        <td>
                            <input type="checkbox" value="1" id="showTitle" checked>
                            Mostrar título
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <input type="checkbox" value="1" id="showDescription" checked>
                            Mostrar descripción
                        </td>
                    </tr>
                <tr id="allChangeThis" style="display: none;">
                    ...
                    <input type="hidden" id="typeDesig" value="responsive">
                        <tr>
                        <td>
                    ...
                    <tr id="trResponsive1">  
                        <td>
                            <div style="width: 200px;">
                                ...
                                <input type="range" class="form-range" min="0" max="6" id="rangeDesktop">
                                ...
                                <input type="range" class="form-range" min="0" max="4" id="rangeTablet">
                                ...
                                <input type="range" class="form-range" min="0" max="2" id="rangeMobile">
                            </div>
                        </td>
                    </tr>
                    <!--Personalizado-->
                    ...
                    <tr id="trPersonali" style="display: none;">
                        ...
                        <td>
                        <div style="width: 200px;">
                        <input type="hidden" id="typeDesigW" value="150">
                        <input type="hidden" id="typeDesigH" value="150">
                    ...
                    <!---FIN--->
                        ...
                        <input type="hidden" id="typeOpenPage" value="_self">
                        <tr>
                        <td>
    ...
    <div id="cardVisual" style="padding:0;width:500px;height:100%;">
        <div class="card-header">
            ...
            <button type="button" class="btn btn-outline-primary" id="activeMB">Mobile</button>
        </div>
